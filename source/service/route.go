...
import (
	...
	workspace_key_delete "github.com/i-sub135/redis-ui/source/feature/public/workspace_key_delete"
...
func (r *Routers) MountRouters(routeGroup *gin.RouterGroup) {
	...
	routeGroup.DELETE("/workspace/:id/key-value", workspace_key_delete.NewHandler(r.store))
}
